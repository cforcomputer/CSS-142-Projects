...
import java.util.Scanner;
 ...
 public class H4P2
{
    //assign boolean values true if called
        ...
        if(start.equalsIgnoreCase("R"))
        {
            ...
            do{ //do-while loop starts the game
                ...
                else if(dice != 1) //game completed message and conditions
                {
                    ...
                    String keyInput = keyboard.nextLine(); //note: keyInput = Scanner
                     
                    if(playerTotalPoints >= 100) //win condition
                    {
                        System.out.println("--------------------------");
                        System.out.println("-  YOU ROLLED: " + dice + "         -");
                        System.out.println("--------------------------");
                    ...
                    if (keyInput.equalsIgnoreCase("R"))
                    {
                    ...
                    if (keyInput.equalsIgnoreCase("h")) 
                    {   
